...
(function ($) {
  ...
  if ($(".project-section-three .inner-box").length) {
    $(".project-section-three .inner-box").on("mouseenter", function () {
      $(this).addClass("active");
      $(".inner-box").removeClass("active");
    });
    $(".project-section-three .inner-box").on("mouseleave", function () {
      $(this).addClass("active");
    });
  }

  // Project Content Active
  if ($(".project-block-three .inner-box").length) {
    $(".project-block-three .inner-box").on("mouseenter", function () {
      $(this).addClass("active");
      $(".inner-box").removeClass("active");
    });
    $(".project-block-three .inner-box").on("mouseleave", function () {
      $(this).addClass("active");
    });
  }

  // Project Content Active
  if ($(".project-block-four .inner-box").length) {
    $(".project-block-four .inner-box").on("mouseenter", function () {
      $(this).addClass("active");
      $(".inner-box").removeClass("active");
    });
    $(".project-block-four .inner-box").on("mouseleave", function () {
      $(this).addClass("active");
    });
  }

  $(".project-section-two .project-block-two").hover(function () {
    $(this).siblings(".project-block-two").removeClass("active"),
      $(this).addClass("active");
  });
  ...
  //Project-carousel
  if ($(".project-two-slider").length) {
    var swiper = new Swiper(".project-two-slider", {
      slidesPerView: 1,
      spaceBetween: 30,
      navigation: {
        nextEl: ".swiper-button-next",
  ...
  //Project-carousel
  if ($(".project-three-slider").length) {
    var swiper = new Swiper(".project-three-slider", {
      slidesPerView: 1,
      spaceBetween: 30,
      navigation: {
        nextEl: ".swiper-button-next",
  ...
  //Project-carousel
  if ($(".services-six-slider").length) {
    var swiper = new Swiper(".services-six-slider", {
      slidesPerView: 1,
      spaceBetween: 14,
      breakpoints: {
        320: {
  ...
  //news-carousel Two
  if ($(".news-two-slider").length) {
    var swiper = new Swiper(".news-two-slider", {
      slidesPerView: 1,
      spaceBetween: 30,
      navigation: {
        nextEl: ".swiper-button-next",
  ...
  //news-carousel Two
  if ($(".team-three-slider").length) {
    var swiper = new Swiper(".team-three-slider", {
      slidesPerView: 1,
      spaceBetween: 30,
      navigation: {
        nextEl: ".swiper-button-next",
